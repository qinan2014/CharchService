...
import com.linelib.openglLib.ShaderUtil;
...
public class SixPointedStar
{
	...
	public SixPointedStar(Resources rs, float r, float R, float z)
	{
	...
	public void initShader(Resources rs)
	{
		//加载顶点着色器的脚本内容
		mVertexShader= ShaderUtil.loadFromAssetsFile("vertex.sh", rs);
		//加载片元着色器的脚本内容
		mFragmentShader=ShaderUtil.loadFromAssetsFile("frag.sh", rs);
		//基于顶点着色器与片元着色器创建程序
